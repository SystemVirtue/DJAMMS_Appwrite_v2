		...
		initializeAuth: async () => {
			...
			try {
				...
				const djammsUser = {
					...
					role: 'user',
					// Use canonical 'prefs' field (stringified JSON) instead of legacy 'preferences'
					prefs: user.prefs ? (typeof user.prefs === 'string' ? user.prefs : JSON.stringify(user.prefs)) : JSON.stringify({}),
