  ...
  try {
    ...
    switch (action) {
      ...
      case "update":
        ...
        if (playlistData.description !== void 0) updateData.description = playlistData.description;
        if (playlistData.isPublic !== void 0) updateData.is_public = playlistData.isPublic;
        if (playlistData.isStarred !== void 0) updateData.is_starred = playlistData.isStarred;
