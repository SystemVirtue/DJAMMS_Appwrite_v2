...
declare module '$env/static/private' {
	export const VITE_APPWRITE_ENDPOINT: string;
	export const VITE_APPWRITE_PROJECT_ID: string;
	export const VITE_APPWRITE_DATABASE_ID: string;
	export const VITE_APPWRITE_API_KEY: string;
	export const VITE_YOUTUBE_API_KEY: string;
